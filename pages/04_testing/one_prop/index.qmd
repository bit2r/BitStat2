...
date: today
image: thumbnail.png
categories: ["비율 검정", "단일 비율 z-검정", "단일 비율 t-검정"]
editor_options: 
...
```{shinylive-r}
#| label: shinylive-one-prop-testing
#| viewerWidth: 800
#| viewerHeight: 700
#| standalone: true
...
# 모집단에서 기대되는 결함률 (모비율)
population_rate <- 0.10

# 단일 비율 z-검정 수행
test_result <- prop.test(observed_defects, total_products, p = population_rate,
